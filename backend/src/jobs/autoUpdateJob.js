...
// Multi-state district mapping - now supports all 28 Indian states
...
export function startAutoUpdateJob() {
    ...
    const job = cron.schedule(schedule, async () => {
        console.log("Starting daily MGNREGA data update for all states...");
        ...
        try {
            ...
            console.log("\n✅ Daily MGNREGA update completed:");
